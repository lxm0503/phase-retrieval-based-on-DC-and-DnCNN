function [] = LoadNetworkWeights(n_layers)
    ...
    if nargin~=0
        if n_layers==17
            ...
            load('E:\study\prDeep-master\prDeep-master\Packages\DnCNN\BestNets_17\DnCNN_17Layer_sigma0to10-best.mat');
            net.layers = net.layers(1:end-1);
            net_0to10 = vl_simplenn_move(net, 'gpu') ;
            %load('./../Packages/DnCNN/BestNets_17/DnCNN_17Layer_sigma10to20-best');%loads net
            load('E:\study\prDeep-master\prDeep-master\Packages\DnCNN\BestNets_17\DnCNN_17Layer_sigma10to20-best');
            net.layers = net.layers(1:end-1);
            net_10to20 = vl_simplenn_move(net, 'gpu') ;
            %load('./../Packages/DnCNN/BestNets_17/DnCNN_17Layer_sigma20to40-best');%loads net
            load('E:\study\prDeep-master\prDeep-master\Packages\DnCNN\BestNets_17\DnCNN_17Layer_sigma20to40-best');
            net.layers = net.layers(1:end-1);
            net_20to40 = vl_simplenn_move(net, 'gpu') ;
            %load('./../Packages/DnCNN/BestNets_17/DnCNN_17Layer_sigma40to60-best');%loads net
            load('E:\study\prDeep-master\prDeep-master\Packages\DnCNN\BestNets_17\DnCNN_17Layer_sigma40to60-best');
            net.layers = net.layers(1:end-1);
            net_40to60 = vl_simplenn_move(net, 'gpu') ;
            %load('./../Packages/DnCNN/BestNets_17/DnCNN_17Layer_sigma60to80-best');%loads net
            load('E:\study\prDeep-master\prDeep-master\Packages\DnCNN\BestNets_17\DnCNN_17Layer_sigma60to80-best');
            net.layers = net.layers(1:end-1);
            net_60to80 = vl_simplenn_move(net, 'gpu') ;
            %load('./../Packages/DnCNN/BestNets_17/DnCNN_17Layer_sigma80to100-best');%loads net
            load('E:\study\prDeep-master\prDeep-master\Packages\DnCNN\BestNets_17\DnCNN_17Layer_sigma80to100-best');
            net.layers = net.layers(1:end-1);
            net_80to100 = vl_simplenn_move(net, 'gpu') ;
            %load('./../Packages/DnCNN/BestNets_17/DnCNN_17Layer_sigma100to150-best');%loads net
            load('E:\study\prDeep-master\prDeep-master\Packages\DnCNN\BestNets_17\DnCNN_17Layer_sigma100to150-best');
            net.layers = net.layers(1:end-1);
            net_100to150 = vl_simplenn_move(net, 'gpu') ;
            %load('./../Packages/DnCNN/BestNets_17/DnCNN_17Layer_sigma150to300-best');%loads net
            load('E:\study\prDeep-master\prDeep-master\Packages\DnCNN\BestNets_17\DnCNN_17Layer_sigma150to300-best');
            net.layers = net.layers(1:end-1);
            net_150to300 = vl_simplenn_move(net, 'gpu') ;
            %load('./../Packages/DnCNN/BestNets_17/DnCNN_17Layer_sigma300to500-best');%loads net
            load('E:\study\prDeep-master\prDeep-master\Packages\DnCNN\BestNets_17\DnCNN_17Layer_sigma300to500-best');
            net.layers = net.layers(1:end-1);
            net_300to500 = vl_simplenn_move(net, 'gpu') ;
            %load('./../Packages/DnCNN/BestNets_17/DnCNN_17Layer_sigma500to1000-best');%loads net
            load('E:\study\prDeep-master\prDeep-master\Packages\DnCNN\BestNets_17\DnCNN_17Layer_sigma500to1000-best');
            net.layers = net.layers(1:end-1);
        ...
        load('E:\study\prDeep-master\prDeep-master\Packages\DnCNN\BestNets_20\DnCNN_20Layer_sigma0to10-best');
        net.layers = net.layers(1:end-1);
        net_0to10 = vl_simplenn_move(net, 'gpu') ;
        %load('./../Packages/DnCNN/BestNets_20/DnCNN_20Layer_sigma10to20-best');%loads net
        load('E:\study\prDeep-master\prDeep-master\Packages\DnCNN\BestNets_20\DnCNN_20Layer_sigma10to20-best');
        net.layers = net.layers(1:end-1);
        net_10to20 = vl_simplenn_move(net, 'gpu') ;
        %load('./../Packages/DnCNN/BestNets_20/DnCNN_20Layer_sigma20to40-best');%loads net
        load('E:\study\prDeep-master\prDeep-master\Packages\DnCNN\BestNets_20\DnCNN_20Layer_sigma20to40-best');
        net.layers = net.layers(1:end-1);
        net_20to40 = vl_simplenn_move(net, 'gpu') ;
        %load('./../Packages/DnCNN/BestNets_20/DnCNN_20Layer_sigma40to60-best');%loads net
        load('E:\study\prDeep-master\prDeep-master\Packages\DnCNN\BestNets_20\DnCNN_20Layer_sigma40to60-best');
        net.layers = net.layers(1:end-1);
        net_40to60 = vl_simplenn_move(net, 'gpu') ;
        %load('./../Packages/DnCNN/BestNets_20/DnCNN_20Layer_sigma60to80-best');%loads net
        load('E:\study\prDeep-master\prDeep-master\Packages\DnCNN\BestNets_20\DnCNN_20Layer_sigma60to80-best');
        net.layers = net.layers(1:end-1);
        net_60to80 = vl_simplenn_move(net, 'gpu') ;
        %load('./../Packages/DnCNN/BestNets_20/DnCNN_20Layer_sigma80to100-best');%loads net
        load('E:\study\prDeep-master\prDeep-master\Packages\DnCNN\BestNets_20\DnCNN_20Layer_sigma80to100-best');
        net.layers = net.layers(1:end-1);
        net_80to100 = vl_simplenn_move(net, 'gpu') ;
        %load('./../Packages/DnCNN/BestNets_20/DnCNN_20Layer_sigma100to150-best');%loads net
        load('E:\study\prDeep-master\prDeep-master\Packages\DnCNN\BestNets_20\DnCNN_20Layer_sigma100to150-best');
        net.layers = net.layers(1:end-1);
        net_100to150 = vl_simplenn_move(net, 'gpu') ;
        %load('./../Packages/DnCNN/BestNets_20/DnCNN_20Layer_sigma150to300-best');%loads net
        load('E:\study\prDeep-master\prDeep-master\Packages\DnCNN\BestNets_20\DnCNN_20Layer_sigma150to300-best');
        net.layers = net.layers(1:end-1);
        net_150to300 = vl_simplenn_move(net, 'gpu') ;
        %load('./../Packages/DnCNN/BestNets_20/DnCNN_20Layer_sigma300to500-best');%loads net
        load('E:\study\prDeep-master\prDeep-master\Packages\DnCNN\BestNets_20\DnCNN_20Layer_sigma300to500-best');
        net.layers = net.layers(1:end-1);
        net_300to500 = vl_simplenn_move(net, 'gpu') ;
        %load('./../Packages/DnCNN/BestNets_20/DnCNN_20Layer_sigma500to1000-best');%loads net
        load('E:\study\prDeep-master\prDeep-master\Packages\DnCNN\BestNets_20\DnCNN_20Layer_sigma500to1000-best');
        net.layers = net.layers(1:end-1);
        net_500to1000 = vl_simplenn_move(net, 'gpu') ;
    end
end
